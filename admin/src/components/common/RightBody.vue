            ...
            <div class="rightbody-header" :style="{width:headerWidth,transition:transition}" >
                ...
                <div class="rightbody-header-body-wrap" ref="road">
                    <div class="rightbody-header-body" ref="navroad"  :style="{marginLeft:navroadMarginLeft+'px',transition:transition}">
                        <div class="rightbody-header-body-item-wrap" :style="{borderLeft:nav.iscurrent?'3px solid #8e30d6':'1px solid #fff'}" v-for="nav in navList" >
                            <div class="rightbody-header-body-item" @click="goNav(nav)">
                                <div class="rightbody-header-body-item-name"   v-text="nav.name">
                                </div>
                            </div>
                            <div  class="rightbody-header-body-item-close"  @click="deleteTag(nav)">
                                <Icon type="md-close" />
                            </div>
                        </div>
                    </div>
