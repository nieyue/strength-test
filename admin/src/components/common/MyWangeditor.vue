  ...
  export default {
    ...
    methods: {
        ...
        '#ff0000','#eb4310','#f6941d','#fbb417','#ffff00','#cdd541','#99cc33','#3f9337','#219167','#239676','#24998d','#1f9baa','#0080ff','#3366cc','#333399','#003366','#800080','#a1488e','#c71585','#bd2158'
             ...
             * 全屏
             */
            var toolbar=document.querySelector("#"+editorId+" .w-e-toolbar");
           var _wangEditor_btn_fullscreen=document.querySelector("#"+editorId+" ._wangEditor_btn_fullscreen");
           console.log(toolbar)
           if(!_wangEditor_btn_fullscreen){
                var wemenu=document.createElement('div');  
                wemenu.setAttribute("class","w-e-menu");
                var aa=document.createElement('a');  
                aa.setAttribute("class","_wangEditor_btn_fullscreen");
                // 创建文本节点  
                var node=document.createTextNode("全屏"); 
                aa.appendChild(node);
                wemenu.appendChild(aa) 
                toolbar.appendChild(wemenu);
                _wangEditor_btn_fullscreen=document.querySelector("#"+editorId+" ._wangEditor_btn_fullscreen");
            ...
            _wangEditor_btn_fullscreen.addEventListener("click",function(ev){
                    toggleClass(document.querySelector("#"+editorId ),'fullscreen-editor');
                    if(_wangEditor_btn_fullscreen.innerText == '全屏'){
                        _wangEditor_btn_fullscreen.innerText='退出全屏';
                    }else{
                        _wangEditor_btn_fullscreen.innerText='全屏';
                    }
                });  
           } 
