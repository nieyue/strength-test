...
-- ----------------------------
INSERT INTO `account_tb` VALUES ('1000', '1000', '11874bb6149dd45428da628c9766b252', '聂跃', null, '3', null, null, '1000@qq.com', null, '0', null, '1', null, null, null, '2019-07-08 18:04:05', '2019-07-18 09:10:56', '1', '1000', null);
...
INSERT INTO `account_tb` VALUES ('1148880505069305858', '15111336558', 'f44f3dd2f74ea4667947fed6b979200d', null, null, '1', null, '测试2', null, '2015-07-15 00:00:00', '5', 'ezuvZuaI', '1', null, null, null, '2019-07-10 17:03:52', '2019-07-10 17:03:52', '1', '1002', null);
...
) ENGINE=InnoDB AUTO_INCREMENT=1151415760540037122 DEFAULT CHARSET=utf8 COMMENT='测评表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1150570249830465538 DEFAULT CHARSET=utf8 COMMENT='权限表';
...
CREATE TABLE `standard_tb` (
  ...
  KEY `INDEX_PROJECTID` (`project_id`) USING BTREE,
  KEY `INDEX_SEX` (`sex`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1151820745203453955 DEFAULT CHARSET=utf8 COMMENT='标准表';
